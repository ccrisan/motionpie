...
def ftpEnabled():
    return {
        ...
        'description': 'enable this if you want to access the files on your motionPie using FTP',
        'type': 'bool',
        'section': 'services',
        'advanced': True,
        'reboot': True,
...
def smbEnabled():
    return {
        ...
        'description': 'enable this if you want to see the files on your motionPie from the local network (using SMB protocol)',
        'type': 'bool',
        'section': 'services',
        'advanced': True,
        'reboot': True,
...
def sshEnabled():
    return {
        ...
        'description': 'enable this if you want to login remotely on your motionPie using an SSH client (such as Putty)',
        'type': 'bool',
        'section': 'services',
        'advanced': True,
        'reboot': True,
